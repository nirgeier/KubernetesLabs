...
- The above deployment contains a web server [`nginx`]
- In order of us to be able to access this `nginx` server we need to create a resource of type `Service` which will "open" the server for incoming traffic

### 3. Create a Service using `kubectl expose`

```sh
# "Expose" the desired port for incomming traffic
...
### 2. Find the port & the IP which was assigned to our pod by the cluster.
...
<div align="center">  
    ...
    <a class="btn btn-success" href="../01-Namespace">01-Namespace</a>
    &nbsp;&nbsp;||&nbsp;&nbsp;
